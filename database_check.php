...
<div id="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="lect3.php">Esercitazione 3</a></li>
					<li class="active">Verifica utente</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<section id="content">
	<div class="container">
		<h1>Cifratura della password</h1>
	...
	<?php
		...
		if($username != "" && $password != ""){
			...
			check_users($username, $password, $hash_type);  //DA COMPLETARE
